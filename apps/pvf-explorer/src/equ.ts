...
export interface RenderedEquReader {
  readRenderedFile(path: string, textProfile?: TextProfile): Promise<string>;
}
...
export async function parseEquFromArchive(
  reader: RenderedEquReader,
  path: string,
